...
const CrimeMovies = () => {
  ...
  const getcrimeMovies = async () => {
    const Api_url =
      "https://api.themoviedb.org/3/discover/movie/?api_key=b6961d8a574415410005902a2f3e4d23&language=en-US&name=Music&with_genres=80";
  ...
  return (
    <>
      <h3 className="top">Crime Movies</h3>
